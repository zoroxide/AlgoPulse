    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          _context.prev = 0;
          _context.next = 3;
          return Blog.find().populate('author', 'username avatar name');
        case 3:
          blogs = _context.sent;
          res.json(blogs);
          _context.next = 10;
    ...
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        ...
        case 3:
          _context2.prev = 3;
          _context2.next = 6;
          return Blog.findById(id).populate('author', 'username avatar name');
        case 6:
          blog = _context2.sent;
          if (blog) {
            _context2.next = 9;
...
exports.upvoteBlog = /*#__PURE__*/function () {
    ...
    return _regeneratorRuntime().wrap(function _callee3$(_context3) {
      while (1) switch (_context3.prev = _context3.next) {
        ...
        case 16:
          ...
          blog.downvotedBy = blog.downvotedBy.filter(function (user) {
...
exports.downvoteBlog = /*#__PURE__*/function () {
    ...
    return _regeneratorRuntime().wrap(function _callee4$(_context4) {
      while (1) switch (_context4.prev = _context4.next) {
        ...
        case 12:
          ...
          return _context4.abrupt("return", res.status(400).json({
            message: 'You have already downvoted this blog'
          }));
        case 16:
          // shhhhhhhhhhhhhhhhh yarab ma7ad ya5od baloh men el 5ara dah
          if (blog.upvotedBy.includes(userId)) {
          ...
          blog.upvotedBy = blog.upvotedBy.filter(function (user) {
            return user.toString() !== userId.toString();
          });
          blog.downvotes += 1;
        ...
        case 25:
          ...
          res.status(500).json({
            message: 'Failed to downvote blog',
